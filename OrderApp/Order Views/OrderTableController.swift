...
class OrderTableController: UITableViewController {
    ...
    @IBSegueAction func confirmOrder(_ coder: NSCoder) -> OrderConfirmationController? {
        return OrderConfirmationController(coder: coder, minutesToPrepare: minutesToPrepareOrder)
    }
